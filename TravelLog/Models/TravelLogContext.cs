...
public partial class TravelLogContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__itinerar__3213E83FA60ECFBA");
        ...
        {
            entity.HasKey(e => e.MiMemberId).HasName("PK__MemberIn__C80AA2624298575F");

            entity.ToTable("MemberInformation");

            entity.HasIndex(e => e.MiEmail, "UQ__MemberIn__67B108C02E63F99C").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__46466601EF1A98BA");
        ...
        {
            entity.HasKey(e => e.OsId).HasName("PK__Order_St__85A5060D5193F673");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__ED10C462D89D3F36");
            ...
            entity.HasOne(d => d.PaymentStatus).WithMany(p => p.Payments)
                ...
                .HasConstraintName("FK__Payment__payment__403A8C7D");
        });

        modelBuilder.Entity<PaymentMethod>(entity =>
        {
            entity.HasKey(e => e.PmId).HasName("PK__Payment___8E8EC76B4E08EECD");
        ...
        {
            entity.HasKey(e => e.PsId).HasName("PK__Payment___011947AC5E46658B");
        ...
        {
            entity.HasKey(e => e.TicketsId).HasName("PK__Tickets__EE5BBABB6C2B7233");
